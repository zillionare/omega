...
class RedisLogReceiver:
    def __init__(self, dsn:str, channel_name:str, filename:str, backup_count: int=7, 
    ...
    fmt:str=None):
        ...
        self._fmt = fmt or "%(asctime)s %(levelname)-1.1s %(process)d %(name)s:%(funcName)s:%(lineno)s | %(message)s"
